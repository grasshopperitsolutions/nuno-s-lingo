      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl border-4 font-black uppercase tracking-wider transition-all active:scale-95 hover:-translate-y-1
            ${
              isDarkMode
          ...
          >
            <svg className={`w-4 h-4 shrink-0 ${isDarkMode ? "fill-white" : "fill-black"}`} viewBox="0 0 24 24">
